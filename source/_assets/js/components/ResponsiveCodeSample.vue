<template>
  <div>
    <div class="flex items-end justify-center mb-2 bg-white">
      ...
      <span class="inline-block text-center cursor-pointer select-none mr-8" :class="activeScreen === 'sm' ? 'text-gray-800' : 'text-gray-500'" @click="activeScreen = 'sm'" >
      ...
      <span class="inline-block text-center cursor-pointer select-none mr-8" :class="activeScreen === 'md' ? 'text-gray-800' : 'text-gray-500'" @click="activeScreen = 'md'" >
      ...
      <span class="inline-block text-center cursor-pointer select-none mr-8" :class="activeScreen === 'lg' ? 'text-gray-800' : 'text-gray-500'" @click="activeScreen = 'lg'" >
      ...
      <span class="inline-block text-center cursor-pointer select-none" :class="activeScreen === 'xl' ? 'text-gray-800' : 'text-gray-500'" @click="activeScreen = 'xl'" >
    ...
    <div class="overflow-hidden mb-8">
      <div class="rounded-t-lg p-4 border-b border-gray-300" style="background-color: #243C5A;">
